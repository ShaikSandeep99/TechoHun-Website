...
import lifetimeaccess from "../assets/services-images/LTA1.jpg";
...
const servicesData = [
  {
    ...
    description: "Earn certificates that are recognized by top tech companies to boost your career."
  },
  {
    id: 2,
    image: liveprojects,
    ...
    <div className="service_homepage">
          ...
          {[
            {
              ...
              desc: `Our online IT training programs are built to help both working people and learners grow their skills from anywhere, at any time. They are budget-friendly, flexible, and easy to learn. Each course is thoughtfully planned to keep you interested and involved, even while studying online. You’ll gain useful, real-life knowledge along with strong basic understanding. These programs are created to prepare you for real-world challenges in today’s fast-changing tech field.`,
            },
            {
            ...
            },
            {
              ...
              desc: `The world of IT is growing and changing every single day. With new tools, technologies, and trends coming up often, it’s important for IT professionals to keep learning and updating their skills. Our internship programs fill this gap, offering practical industry exposure and teamwork, leadership, and communication development.`,
            },
          ].map((service, idx) => (
            <section
              id={service.id}
      ...
      <section className="service_features">
        ...
        <div className="service_features-grid">
          <div className="service_feature-card">
            ...
            <p>We ensure every course is completed on time with a perfect balance of theory and practice.</p>
          </div>
          <div className="service_feature-card">
            <i className="fas fa-building icon green"></i>
            <h3>State-of-the-art Infrastructure</h3>
            <p>At TECHNOHUB, students study in a learning environment supported by modern infrastructure, tools and labs.</p>
          </div>
          <div className="service_feature-card">
            <i className="fas fa-sync-alt icon red"></i>
            <h3>Blended Training Approach</h3>
            <p>We adopt an integrated approach to training that helps our students get both IT knowledge and skills.</p>
          </div>
          <div className="service_feature-card">
            <i className="fas fa-handshake icon yellow"></i>
            <h3>Free Demo Sessions</h3>
            <p>We also provide prospective students with the option to try the courses with free demo sessions.</p>
          </div>
        </div>
      </section>
      ...
      <section className="service_why-choose-us" id="why-choose-us">
        <div className="service_container">
          <h2>Why Choose Us?</h2>
          <p>
            Our platform is built to provide not only knowledge but also mentorship and career acceleration 
            with real-world projects and industry-aligned curriculum.
          </p>
          <div className="service_why-grid">
            <div className="service_why-card">
              <h3>Expert Mentors</h3>
              <p>Learn from professionals who actively work in the industry with years of experience.</p>
            </div>
            <div className="service_why-card">
              <h3>Real Projects</h3>
              <p>Work on actual business problems to prepare for interviews and the workplace.</p>
            </div>
            <div className="service_why-card">
              <h3>Career Support</h3>
              <p>Mock interviews, resume reviews, and job referrals for our top-performing students.</p>
            </div>
          </div>
        </div>
      </section>
